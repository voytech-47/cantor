    ...
    <div id="wrapper">
        <div id="banner">
            ...
            <ul style="flex-grow: 2;">
                <li><a href="./usd.php">Kurs EUR</a></li>
            ...
            <?php
                ...
                if (mysqli_connect_errno()) {
                    ...
                    if (isset($_POST['czek']) AND $_POST['czek'] == 'on') {
                        $selectAll = "SELECT * FROM kursy WHERE KodWaluty = 'EUR' ORDER BY Data DESC;";
                    } elseif (!isset($_POST['selectDate'])) {
                        $selectAll = "SELECT * FROM kursy WHERE Data = '".$doSelecta."' AND KodWaluty = 'EUR' ORDER BY Data DESC;";
                    } else {
                        $selectAll = "SELECT * FROM kursy WHERE Data = '".$_POST['selectDate']."' AND KodWaluty = 'EUR' ORDER BY Data DESC;";
                    }
                    $selectAllTitle = "SELECT * FROM kursy WHERE KodWaluty = 'EUR';";
                    ...
                    if (isset($_POST['czek']) AND $_POST['czek'] == 'on') {
                        echo "<h2>Aktualne kursy EUR od dnia: ".$rowTemp[1]."</h2>";
                    } else {
                        echo "<h2>Aktualny kurs EUR z dnia: ".$rowTemp[1]."</h2>";
                    }
                    echo "<table>";
                    ...
                    if (!isset($_POST['sourceCurr1']) or !isset($_POST['sourceCurr2'])) {
                        ...
                        echo "<div style='font-size: 20px; color: rgb(29,45,79); text-align: center; margin-top: 1rem; display: flex; flex-direction: row; justify-content: center; align-items: stretch;'><input name='sourceCurr2' id='sourceCurr2' type='number' min = 0 step= 0.01 value=1 oninput='calculateFrom(this.value)'><b>&nbspEUR →&nbsp</b><input type='number' disabled id='targetCurr2' value = ".$kurs."><b>&nbspPLN</b></div>";
                    } else {
                        ...
                        echo "<div style='font-size: 20px; color: rgb(29,45,79); text-align: center; margin-top: 1rem; display: flex; flex-direction: row; justify-content: center; align-items: stretch;'><input name='sourceCurr2' id='sourceCurr2' type='number' min = 0 step= 0.01 value=".$_POST['sourceCurr2']." oninput='calculateFrom(this.value)'><b>&nbspUSD →&nbsp</b><input type='number' disabled id='targetCurr2' value = ".$kurs."><b>&nbspPLN</b></div>";
                    }
                    }
